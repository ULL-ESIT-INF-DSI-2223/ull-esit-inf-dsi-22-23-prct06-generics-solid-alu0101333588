...
console.log(
  `concatenate(): [${lista_prueba_2.concatenate(listas_para_concatenar)}]`
);
console.log(
  `filter(): [${lista_prueba.filter((elemento) => elemento === 20 + 3)}]`
);
console.log(`length(): [${lista_prueba_2.length()}]`);
console.log(`map(): [${lista_prueba_2.map((elemento) => elemento * 2)}]`);
console.log(
  `reduce(): [${lista_prueba_2.reduce(
...
let numero: number = 1;
console.log(
  `forEach(): [${lista_prueba_2.forEach((elemento) => (numero *= elemento))}]`
);
