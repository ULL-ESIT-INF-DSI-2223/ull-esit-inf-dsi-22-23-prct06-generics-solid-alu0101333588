...
describe("Test Clase Discografía", () => {
  ...
  let discografia_prueba: Discografia<Disco> = new Discografia<Disco>(
    conjunto_discos
  );

  let single_prueba: Single = new Single("Disco de oro", 1999, [
    cancion_prueba,
  ]);
  let conjunto_single: Single[] = [single_prueba];
  let discografia_prueba_2: Discografia<Single> = new Discografia<Single>(
    conjunto_single
  );
